														...
														void*					pCookie)
{
	...
	/*printf("Wave Position: (%f,%f,%f)\n", pEndPosition->Z/1000.0, pEndPosition->X/-1000.0, pEndPosition->Y/1000.0);
	char* str = new char[30];
 
					//publish to Main_Control
					sprintf(str,"%f,%f,%f",pEndPosition->Z/1000.0, pEndPosition->X/-1000.0, pEndPosition->Y/1000.0);
					state =str;*/
	//std_msgs::String msg;
	...
	msg.point.x = pEndPosition->X/1000.0;
	msg.point.y = pEndPosition->Y/1000.0;
	msg.point.z = pEndPosition->Z/1000.0;
...
void XN_CALLBACK_TYPE HandTracker::Hand_Create(	xn::HandsGenerator& generator, 
												...
												void*				pCookie)
{
	printf("New Hand: %d @ (%f,%f,%f)\n", nId, pPosition->Z/1000.0, pPosition->X/-1000.0, pPosition->Y/1000.0);
